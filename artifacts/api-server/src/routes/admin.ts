...
import { eq, sql, desc, gte, lte, ilike, and, count } from "drizzle-orm";
...
router.get("/admin/low-stock", requireAdmin, async (_req, res): Promise<void> => {
...
router.get("/admin/sales-chart", requireAdmin, async (req, res): Promise<void> => {
