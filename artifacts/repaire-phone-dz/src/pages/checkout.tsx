  ...
  if (orderComplete) {
    return (
      <div className="container mx-auto px-4 py-20 max-w-2xl text-center">
        ...
        <h2 className="text-3xl font-extrabold mb-4 tracking-tight">Commande Confirmée !</h2>
        <p className="text-muted-foreground text-lg mb-2">
          Merci pour votre confiance. Votre commande <span className="font-bold text-foreground">#{orderComplete.id}</span> a bien été enregistrée.
        </p>
        <p className="text-muted-foreground mb-8">
          Notre équipe vous contactera prochainement pour confirmer la livraison.
        </p>
        ...
        <div className="flex-1 w-full space-y-6">
          ...
          <Card className="border-border shadow-sm">
            <CardContent className="p-6">
              ...
              <div className="p-4 border border-primary bg-primary/5 rounded-lg flex items-center gap-4">
                <input type="radio" checked readOnly className="w-5 h-5 text-primary" />
                <div>
                  <h4 className="font-bold text-foreground">Paiement à la livraison</h4>
